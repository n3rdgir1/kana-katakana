        ...
        <div className="main">
          <nav className="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div className="navbar" id="navbarNav">
              <Link to='/katakana' className="nav-item nav-link" activeClassName='active'> Katakana </Link>
              <Link to='/hiragana' className="nav-item nav-link" activeClassName='active'> Hiragana </Link>
            </div>
          </nav>
